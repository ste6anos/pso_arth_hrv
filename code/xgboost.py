...
def create_html_report(results, config, output_file='xgboost_report_dual_state_90m.html'):
    """Generate professional HTML report for XGBoost results with side-by-side comparison."""
...
<head>
    ...
    <title>XGBoost - Dual State Analysis</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>XGBoost Analysis - Dual State Comparison</h1>
        ...
        <div class="content">
            ...
            <div class="config-section">
                ...
                <div class="config-grid">
                    ...
                    <p><strong>Subsample:</strong> {config['subsample']}</p>
                    <p><strong>Colsample ByTree:</strong> {config['colsample_bytree']}</p>
...
"""
    ...
    html += """
        ...
        <div class="footer">
            <p>XGBoost Regression | Dual State HRV Metrics Analysis</p>
        </div>
    </div>
</body>
</html>
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("XGBOOST - DUAL STATE ANALYSIS")
    print("="*60)
    ...
    for target in y_df.columns[1:]:
        ...
        for state_name, X_df in [('low_hr', X_df_sl), ('high_hr', X_df_aw)]:
            ...
            colors = plt.cm.Oranges(np.linspace(0.5, 0.9, len(top_features)))
    ...
    create_html_report(results, config, output_file='xgboost_report_dual_state_90m.html')
    ...
    summary_df.to_csv('xgboost_summary_dual_state.csv', index=False)
    print("\nSummary CSV saved to 'xgboost_summary_dual_state.csv'")
    print("\nDual-state XGBoost analysis complete!")
...
def create_html_report(results, config, output_file='xgboost_reverse_report_dual_state_90m.html'):
    """Generate professional HTML report for XGBoost REVERSE results with side-by-side comparison."""
...
<head>
    ...
    <title>XGBoost REVERSE - Dual State Analysis</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="header">
            <h1>XGBoost REVERSE Analysis - Dual State Comparison</h1>
...
"""
    ...
    html += """
        ...
        <div class="footer">
            <p>XGBoost REVERSE Regression | Clinical Data → HRV Metrics Prediction</p>
        </div>
    </div>
</body>
</html>
...
if __name__ == "__main__":
    ...
    print("="*60)
    print("XGBOOST REVERSE - DUAL STATE ANALYSIS")
    ...
    create_html_report(results, config, output_file='xgboost_reverse_report_dual_state_90m.html')
    ...
    summary_df.to_csv('xgboost_reverse_summary_dual_state.csv', index=False)
    print("\nSummary CSV saved to 'xgboost_reverse_summary_dual_state.csv'")
    print("\nDual-state XGBoost REVERSE analysis complete!")